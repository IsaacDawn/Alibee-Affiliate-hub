...
`,Sn=({product:e,onLike:t,onShare:r,onBuy:o,isLiked:s=!1,showDebug:i=!1})=>{const{t:a,currentLanguage:c}=ur(),[l,d]=n.useState(e.customTitle||e.title||"Product Title");n.useEffect(()=>{d(e.customTitle||e.title||"Product Title")},[e.customTitle,e.title]);const u=[e.image,...Array.isArray(e.images)?e.images:[]].filter(Boolean).filter((e,t,r)=>r.indexOf(e)===t),p=e.video&&""!==e.video.trim(),g=p?e.video:null,[h,f]=n.useState(!1),[m,x]=n.useState(0),[y,b]=n.useState(null),[w,v]=n.useState(null),[S,E]=n.useState(new Set),[k,C]=n.useState(!1),[N,T]=n.useState(p),[P,R]=n.useState(!1),O=n.useRef(null),L=n.useRef(null),_=e=>new Promise((t,r)=>{if(sn.has(e))return void t();const n=new Image;n.onload=()=>{sn.set(e,n),E(t=>new Set([...t,e])),t()},n.onerror=r,n.src=e});n.useEffect(()=>{u.length>0&&(async()=>{if(u[m])try{await _(u[m])}catch(t){}const e=u.map(e=>_(e));try{await Promise.all(e)}catch(t){}})()},[u.join(","),m]);const A=async()=>{if(p&&N){T(!1);const t=u.length-1,r=u[t];if(!S.has(r)){R(!0);try{await _(r)}catch(e){}finally{R(!1)}}x(t)}else if(m>0){const t=m-1,r=u[t];if(!S.has(r)){R(!0);try{await _(r)}catch(e){}finally{R(!1)}}x(t)}else if(p)T(!0);else if(u.length>1){const t=u.length-1,r=u[t];if(!S.has(r)){R(!0);try{await _(r)}catch(e){}finally{R(!1)}}x(t)}},D=async()=>{if(p&&!N&&m===u.length-1)T(!0);else if(m<u.length-1){const t=m+1,r=u[t];if(!S.has(r)){R(!0);try{await _(r)}catch(e){}finally{R(!1)}}x(t)}else if(p&&N){T(!1);const t=0,r=u[t];if(!S.has(r)){R(!0);try{await _(r)}catch(e){}finally{R(!1)}}x(t)}else if(u.length>1){const t=0,r=u[t];if(!S.has(r)){R(!0);try{await _(r)}catch(e){}finally{R(!1)}}x(t)}};n.useEffect(()=>{const e=u[m];e&&(S.has(e)?f(!0):f(!1))},[m,S,u]),n.useEffect(()=>{if(!p||!O.current)return;const e=new IntersectionObserver(e=>{e.forEach(e=>{const t=e.isIntersecting;C(t),L.current&&N&&(t?L.current.play().catch(console.error):L.current.pause())})},{threshold:.3,rootMargin:"0px 0px 0px 0px"});return e.observe(O.current),()=>{e.disconnect()}},[p,N]),n.useEffect(()=>{if(u.length<=1||p)return;const e=setInterval(async()=>{if(h&&!P){const t=(m+1)%u.length,r=u[t];if(S.has(r))x(t);else{R(!0);try{await _(r),x(t)}catch(e){x(t)}finally{R(!1)}}}},3e3);return()=>clearInterval(e)},[u.length,h,m,p,S,P]);const U=(e,t)=>`${{USD:"$",EUR:"€",ILS:"₪"}[t]||"$"}${parseFloat(e.toString()).toFixed(2)}`,F=e.discount||e.discountPercentage?Math.round(e.discount||e.discountPercentage||0):null;return j.jsxs(cn,{className:"fade-in",children:[j.jsxs(ln,{ref:O,onTouchStart:e=>{v(null),b(e.targetTouches[0].clientX)},onTouchMove:e=>{v(e.targetTouches[0].clientX)},onTouchEnd:()=>{if(!y||!w)return;const e=y-w,t=e<-50;e>50?D():t&&A()},onKeyDown:e=>{"ArrowLeft"===e.key?A():"ArrowRight"===e.key&&D()},tabIndex:0,children:[p&&N?j.jsx("video",{ref:L,src:g,muted:!0,loop:!0,playsInline:!0,controls:!0,controlsList:"nodownload nofullscreen noremoteplayback",style:{width:"100%",height:"100%",objectFit:"cover"}}):e.image&&j.jsxs(j.Fragment,{children:[j.jsx(dn,{src:u[m],alt:e.title,onLoad:()=>f(!0),style:{opacity:h?1:0}}),!h&&j.jsx(un,{children:j.jsx(pn,{})})]}),(p||u.length>1)&&j.jsxs(j.Fragment,{children:[j.jsx(fn,{$position:"left",onClick:A,"aria-label":"Previous",style:{opacity:.9,cursor:"pointer"},children:"‹"}),j.jsx(fn,{$position:"right",onClick:D,"aria-label":"Next",style:{opacity:.9,cursor:"pointer"},children:"›"})]}),F&&j.jsxs(mn,{children:["-",F,"%"]}),j.jsx(xn,{className:s?"liked":"",onClick:r=>{r.stopPropagation(),t&&t(e.id)},children:j.jsx(rn,{fill:s?"currentColor":"none"})}),j.jsx(jn,{onClick:()=>{o&&o(e)},children:j.jsx(nn,{})}),(u.length>1||p)&&j.jsxs(gn,{children:[p&&j.jsx(hn,{$active:!!N,onClick:()=>{T(!0)},style:{backgroundColor:N?"#3b82f6":"#6b7280"}}),u.map((e,t)=>j.jsx(hn,{$active:t===m&&!N,onClick:()=>{x(t),T(!1)}},t))]})]}),j.jsxs(yn,{children:[j.jsx(an,{value:l,onChange:t=>{d(t),e.onTitleChange&&e.onTitleChange(e.id,t)},style:{fontSize:"18px",fontWeight:"bold",marginBottom:"10px",color:"#fff",background:"transparent",border:"none",outline:"none",textAlign:"center",width:"100%",padding:"8px",borderRadius:"6px",transition:"all 0.2s ease"}}),j.jsx("div",{style:{display:"flex",justifyContent:"center",marginBottom:"8px"},children:j.jsxs(vn,{$currentLang:c,style:{background:"rgba(0, 0, 0, 0.3)",border:"1px solid rgba(255, 255, 255, 0.2)",borderRadius:"6px",padding:"4px 12px",fontSize:"11px",textAlign:"center",color:"#ffffff"},children:[j.jsxs("span",{className:"lang-en",children:["Category: ",e.firstLevelCategoryName||e.category||"General"]}),j.jsxs("span",{className:"lang-he",children:["קטגוריה: ",e.firstLevelCategoryName||e.category||"General"]}),j.jsxs("span",{className:"lang-ar",children:["الفئة: ",e.firstLevelCategoryName||e.category||"General"]})]})}),j.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px",marginBottom:"8px"},children:[j.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[j.jsxs(vn,{$currentLang:c,style:{color:"#fbbf24"},children:[j.jsxs("span",{className:"lang-en",children:["ID: ",e.id]}),j.jsxs("span",{className:"lang-he",children:["מזהה: ",e.id]}),j.jsxs("span",{className:"lang-ar",children:["المعرف: ",e.id]})]}),j.jsxs(vn,{$currentLang:c,style:{color:"#ffffff"},children:[j.jsxs("span",{className:"lang-en",children:["Price: ",U(e.priceTarget||e.price||0,e.currencyTarget||e.currency)]}),j.jsxs("span",{className:"lang-he",children:["מחיר: ",U(e.priceTarget||e.price||0,e.currencyTarget||e.currency)]}),j.jsxs("span",{className:"lang-ar",children:["السعر: ",U(e.priceTarget||e.price||0,e.currencyTarget||e.currency)]})]}),(e.originalPriceTarget||e.originalPrice)&&j.jsxs(vn,{$currentLang:c,style:{color:"#ff6b6b",textDecoration:"line-through"},children:[j.jsxs("span",{className:"lang-en",children:["Original Price: ",U(e.originalPriceTarget||e.originalPrice||0,e.currencyTarget||e.currency)]}),j.jsxs("span",{className:"lang-he",children:["מחיר מקורי: ",U(e.originalPriceTarget||e.originalPrice||0,e.currencyTarget||e.currency)]}),j.jsxs("span",{className:"lang-ar",children:["السعر الأصلي: ",U(e.originalPriceTarget||e.originalPrice||0,e.currencyTarget||e.currency)]})]}),j.jsxs(vn,{$currentLang:c,style:{color:"#60a5fa"},children:[j.jsxs("span",{className:"lang-en",children:["Currency Type: ",e.currencyTarget||e.currency]}),j.jsxs("span",{className:"lang-he",children:["סוג מטבע: ",e.currencyTarget||e.currency]}),j.jsxs("span",{className:"lang-ar",children:["نوع العملة: ",e.currencyTarget||e.currency]})]})]}),j.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[j.jsxs(vn,{$currentLang:c,style:{color:"#fbbf24"},children:[j.jsxs("span",{className:"lang-en",children:["Discount: ",(e.discount||e.discountPercentage||0).toFixed(1),"%"]}),j.jsxs("span",{className:"lang-he",children:["הנחה: ",(e.discount||e.discountPercentage||0).toFixed(1),"%"]}),j.jsxs("span",{className:"lang-ar",children:["الخصم: ",(e.discount||e.discountPercentage||0).toFixed(1),"%"]})]}),j.jsxs(vn,{$currentLang:c,style:{color:"#fb7185"},children:[j.jsxs("span",{className:"lang-en",children:["Commission: ",e.commissionRate||0,"%"]}),j.jsxs("span",{className:"lang-he",children:["עמלה: ",e.commissionRate||0,"%"]}),j.jsxs("span",{className:"lang-ar",children:["العمولة: ",e.commissionRate||0,"%"]})]}),j.jsxs(vn,{$currentLang:c,style:{color:"#34d399"},children:[j.jsxs("span",{className:"lang-en",children:["Sales Volume: ",(e.volume||e.salesVolume||0).toLocaleString()]}),j.jsxs("span",{className:"lang-he",children:["נפח מכירות: ",(e.volume||e.salesVolume||0).toLocaleString()]}),j.jsxs("span",{className:"lang-ar",children:["حجم المبيعات: ",(e.volume||e.salesVolume||0).toLocaleString()]})]}),j.jsxs(vn,{$currentLang:c,style:{color:"#a78bfa",gap:"6px",flexDirection:"row",alignItems:"center"},children:[j.jsx("span",{className:"lang-en",children:"Rating:"}),j.jsx("span",{className:"lang-he",children:"דירוג:"}),j.jsx("span",{className:"lang-ar",children:"التقييم:"}),j.jsx(bn,{children:(e=>{const t=[],r=Math.floor(e),n=e%1!=0;for(let o=0;o<5;o++)o<r||o===r&&n?t.push(j.jsx(wn,{$filled:!0,children:"★"},o)):t.push(j.jsx(wn,{children:"☆"},o));return t})(e.productScoreStars||e.scoreStars||e.rating||0)})]})]})]})]}),i&&j.jsx(on,{product:e,isVisible:i})]})},En=s.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
